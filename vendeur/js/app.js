...
function showInstallOverlay(appName, onDone) {
  ...
  if (isIOS) {
    overlay.innerHTML = `<div style="background:#1A0A02;border-radius:24px 24px 0 0;padding:28px 24px 44px;width:100%;border-top:1px solid rgba(255,255,255,.1)"><div style="text-align:center;margin-bottom:20px"><div style="font-size:40px;margin-bottom:8px">📲</div><div style="font-size:18px;font-weight:900;color:#fff;margin-bottom:4px">Installer ${appName}</div><div style="font-size:12px;color:rgba(255,255,255,.4)">Suis les 4 étapes ci-dessous</div></div><div style="display:flex;flex-direction:column;gap:8px;margin-bottom:20px"><div style="display:flex;align-items:center;gap:12px;background:rgba(255,255,255,.05);border-radius:12px;padding:12px 14px"><div style="background:rgba(232,87,10,.15);border-radius:8px;width:28px;height:28px;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:13px;font-weight:900;color:#E8570A">1</div><div><div style="font-size:13px;font-weight:700;color:#fff">Appuie sur <span style="color:#E8570A">•••</span> en bas à droite</div><div style="font-size:11px;color:rgba(255,255,255,.4);margin-top:2px">Les 3 points dans la barre Safari</div></div></div><div style="display:flex;align-items:center;gap:12px;background:rgba(255,255,255,.05);border-radius:12px;padding:12px 14px"><div style="background:rgba(232,87,10,.15);border-radius:8px;width:28px;height:28px;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:13px;font-weight:900;color:#E8570A">2</div><div><div style="font-size:13px;font-weight:700;color:#fff">Appuie sur <span style="color:#E8570A">Partager ⎙</span></div><div style="font-size:11px;color:rgba(255,255,255,.4);margin-top:2px">Dans le menu qui apparaît</div></div></div><div style="display:flex;align-items:center;gap:12px;background:rgba(255,255,255,.05);border-radius:12px;padding:12px 14px"><div style="background:rgba(232,87,10,.15);border-radius:8px;width:28px;height:28px;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:13px;font-weight:900;color:#E8570A">3</div><div><div style="font-size:13px;font-weight:700;color:#fff">Appuie sur <span style="color:#E8570A">Plus d'options</span></div><div style="font-size:11px;color:rgba(255,255,255,.4);margin-top:2px">L'icône en bas du menu de partage</div></div></div><div style="display:flex;align-items:center;gap:12px;background:rgba(255,255,255,.05);border-radius:12px;padding:12px 14px"><div style="background:rgba(232,87,10,.15);border-radius:8px;width:28px;height:28px;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:13px;font-weight:900;color:#E8570A">4</div><div><div style="font-size:13px;font-weight:700;color:#fff">Appuie sur <span style="color:#E8570A">Sur l'écran d'accueil ➕</span></div><div style="font-size:11px;color:rgba(255,255,255,.4);margin-top:2px">Confirme en haut à droite</div></div></div></div><button id="_installDismiss" style="width:100%;padding:14px;background:rgba(232,87,10,.12);border:1px solid rgba(232,87,10,.3);border-radius:14px;color:#E8570A;font-size:14px;font-weight:700;cursor:pointer">J'ai compris ✓</button></div><div style="position:absolute;bottom:12px;left:50%;animation:_bounce 1.2s ease infinite;font-size:26px">⬇️</div>`;
